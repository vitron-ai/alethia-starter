...
//
// Both frameworks test the same five-step flow against the same Atlas app.
...
test('atlas smoke', async ({ page }) => {
  await page.goto('http://127.0.0.1:5173');
  await expect(page.getByText('Atlas', { exact: false })).toBeVisible();
